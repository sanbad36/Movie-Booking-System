...
import com.sanket.MovieBookingApplication_LLD.controller.TicketController;

import java.util.List;

public class TicketBookingRunner implements Runnable{
    private TicketController ticketController;
    private Long showId;
    private List<Long> showSeatId;
    private Long userId;

    public TicketBookingRunner(TicketController ticketController,
                            Long showId,
